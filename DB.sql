...
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`) VALUES (1,3, '待机,一级,二级,三级,进入下一阶段');
...
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`) VALUES (3,11, '');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`) VALUES (4,9, '方块,凹凸,12块,20块,启动,监视器,结束,下课');
