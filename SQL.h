...
#define SQL_SELECT_TEACHER_DETAILINFO "SELECT t.first_name, t.last_name, t.account, r.path AS pic_name FROM teacher as t, resource as r WHERE r.resource_id=t.picture_id AND t.account=?"
